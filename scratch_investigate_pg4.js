...
async function run() {
  ...
  const cRes = await client.query('SELECT id, status, "contractCode", p1c, p2c, p3c, p4c, p5c, p6c FROM "Contract" WHERE "supplyPointId" = (SELECT id FROM "SupplyPoint" WHERE cups = \'ES0031105131691001XN0F\')');
