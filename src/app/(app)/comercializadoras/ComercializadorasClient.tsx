                ...
                {companies.map(c => (
                  <React.Fragment key={c.id}>
                    <tr style={{ background: editingId === c.id ? 'var(--bg-elevated)' : 'transparent' }}>
                      ...
                      <td style={{ fontFamily: 'monospace', color: 'var(--text-secondary)' }}>{c.cie || '-'}</td>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
                              ...
                              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                                  ...
                                  <div>
                                    <label className="text-xs text-slate-400 mb-1 block">CIE Presentador</label>
                                    <input type="text" className="w-full bg-slate-900 border border-slate-700 rounded-lg p-2 text-sm text-white" value={formData.cie || ''} onChange={e => handleChange('cie', e.target.value)} />
                                  </div>
                                  <div>
