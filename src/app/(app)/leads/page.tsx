...
export default async function LeadsPage() {
  try {
    ...
    return (
      <div className="p-8 bg-red-100 text-red-900 border border-red-300 rounded-lg m-4">
        <h1 className="text-xl font-bold mb-4">Error CRITICO en /leads</h1>
        <p><strong>Message:</strong> {e.message}</p>
        <p><strong>Code:</strong> {e.code}</p>
        <p><strong>Meta:</strong> {JSON.stringify(e.meta)}</p>
      </div>
    )
  }
}
