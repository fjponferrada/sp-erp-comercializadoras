    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      <div style={{ padding: '24px 32px', maxWidth: '1600px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '24px', paddingBottom: '120px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
          ...
          <div style={{ marginLeft: 'auto', alignSelf: 'flex-end', width: '100%', display: 'flex', justifyContent: 'flex-end', marginTop: '16px' }}>
            <button
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: 'right' }}>Base Imponible<br/>Factura</th>
              ...
              <tbody style={{ fontSize: '0.8rem' }}>
                {detailedResults.length === 0 ? (
                  <tr>
                    <td colSpan={18} style={{ padding: '48px', textAlign: 'center', color: 'var(--text-muted)' }}>
                  ...
                  detailedResults.map((row) => (
                    <tr key={row.id}>
                      ...
                      <td style={{ textAlign: 'right', fontFamily: 'monospace', fontWeight: 500 }}>{formatCurrency(row.baseImponibleFactura)}</td>
