        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < boe_1.length)) return [3 /*break*/, 6];
                    b = boe_1[_i];
                    return [4 /*yield*/, prisma_1.prisma.regulatedCost.findFirst({
...
seedVE().finally(function () { return prisma_1.prisma.$disconnect(); });
