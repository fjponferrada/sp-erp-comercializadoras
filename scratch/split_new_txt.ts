...
// File 1 target: 1532.00
const cuota98 = 3.72 + 67.62 + 7.01; // 78.35
const amSbfoCuota = 1532.00 - cuota98; // 1453.65
const junSbfoCuota = sbfo.cuota - amSbfoCuota; // 12137.15
...
fs.writeFileSync('Z:\\AED\\AEAT\\560\\Desglose_560_Espaa_2026_T2_Abril_Mayo_CORREGIDO.txt', outAM);
fs.writeFileSync('Z:\\AED\\AEAT\\560\\Desglose_560_Espaa_2026_T2_Junio_CORREGIDO.txt', outJun);

console.log("Splitted perfectly using the new original file.");
