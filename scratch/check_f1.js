...
async function main() {
    ...
    const f1Res = await client.query(`
        SELECT f."importeTotalFactura", f."baseImponible", f."cuotaIva"
        FROM "F1Invoice" f
    ...
    console.log("F1 INVOICE:");
    console.log(f1Res.rows[0]);
    
    const invRes = await client.query(`
        SELECT i."totalAmount", i."totalBase", i."subtotal1", i."taxAmount"
        FROM "Invoice" i
